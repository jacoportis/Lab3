...
\end{esempio}
\footnotetext[3]{I $\gamma$ corrispondono a transizioni tra livelli nucleari, per cui non possono assumere qualsiasi valore di energia bensì hanno dei valori ben precisi, corrispondenti alla differenza energetica dei livelli tra cui avviene la transizione.}
...
Per calcolare le fluttuazioni è necessario considerare due casi.\footnote{Precisiamo che il ragionamento che segue è inerente alle distribuzioni delle particelle che si producono, altrimenti dimensionalmente non tornerebbero i conti.}
...
\begin{esempio}
   ...
   \begin{minipage}{0.6\textwidth}
      ...
      \end{equation*}
      misurate con un rivelatore di silicio.
...
\begin{esempio}[La misura del tempo di volo]
   ...
   \begin{equation*}
      \text{TOF}=t_2 - t_1
      \qqtext{,}
      \sigma_t=\sqrt{\sigma_{t,1}^2 + \sigma_{t,2}^2}
   \end{equation*}
\end{esempio}
