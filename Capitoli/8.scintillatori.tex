...
\begin{itemize}[leftmargin=0.5cm]
   ...
   \item Bioluminescenza attraverso organismi viventi, tipicamente quelli marini.%Bioluminescenza: è il risultato di reazioni chimiche che avvengono all'interno di cellule specializzate che permettono ad alcuni organismi viventi di emettere luce. \E tipica degli organismi marini ma anche alcuni organismi terrestri come le lucciole la possiedono.
\end{itemize}
...
Osserviamo innanzitutto che questa luce di scintillazione è associata a transizioni di elettroni di valenza liberi, i quali sono degli elettroni che appartengono alla molecola ma non sono associati a uno specifico atomo di questa. Andiamo allora a vedere i livelli che può occupare un elettrone di questo tipo.
...
\subsection{Vantaggi degli scintillatori organici rispetto a quelli inorganici}
...
\begin{esempio}[Alcuni esempi di scintillatori plastici]
   ...
   \begin{center}
      \begin{tabular}{|lcccc|}
        ...
        \hline
        Wavelength peak [nm] & 408 & 391 & 391 & 370\\
        \hline
      ...
      \end{tabular}
    \end{center}
   Vediamo che, rispetto agli scintillatori inorganici, i tempi di emissione sono molto più rapidi, dell'ordine di alcuni nanosecondi. Inoltre in questo caso la light yield viene riportata in percentuale rispetto a quella dell'antracene.
\end{esempio}
...
Quando una particella attraversa lo scintillatore, i fotoni di scintillazione prodotti vengono emessi in tutte le direzioni, per cui se se non ricoprissimo le pareti dello scintillatore con qualche materiale nel momento in cui i fotoni raggiungono il bordo dello scintillatore essi subirebbero rifrazione e fuoriuscirebbero, e ciò significherebbe perderli.\footnote{Piccola curiosità: la prof La Rocca lavorò con il padre di Marco Russo, il quale diceva sempre che: ``I fotoni sono bastardi'' perché escono e anche una leggerissima crepa nella copertura comporta delle perdite notevoli in termini di raccolta della luce.}
...
Lo scopo della PET consiste nell'individuare l'eventuale presenza di cellule cancerogene, che sono tipicamente delle cellule che hanno un elevato consumo di glucosio. Nel paziente viene quindi iniettato un liquido che contiene del glucosio e un elemento tracciante, cioè un isotopo che tipicamente emette dei positroni e una volta emessi questi si annichilano e danno luogo a due $\gamma$ identici emessi a $180^{\circ}$.
\begin{figure}[H]
   \centering
