...
\end{itemize}
Tuttavia ancora si deve lavorare un po' sulle dimensioni le quali sono ancora piccole e sul dark count rate, cioè quel rumore che è sempre presente nei fotosensori anche in assenza di radiazione, che in questo caso può essere anche molto elevato (100 kHz 1 MHz/mm 2), dipende dal produttore.
