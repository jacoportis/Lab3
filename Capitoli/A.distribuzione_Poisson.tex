...
\begin{esempio}[La probabilità di fare tre volte 1 a dadi con tre tiri]
   ...
   \begin{center}
      ...
      \end{tabular}
   \end{center}
   Notiamo che, nei casi in cui otteniamo una o due volte la faccia con il numero 1, ciò che cambia rispetto agli altri casi è che si possono avere diverse configurazioni in base a qual è il lancio in cui si ha successo.
\end{esempio}
